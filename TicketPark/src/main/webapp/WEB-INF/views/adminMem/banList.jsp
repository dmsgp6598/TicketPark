...
<div style="margin-bottom:20px; margin-left:350px;" align="left">
    ...
    <script type="text/javascript">
        ...
        function fn_openBanList() {
           	var keyword = $('#keyword').val();
			var comsubmit = new ComSubmit();
			comsubmit.addParam("keyword", keyword);
			comsubmit.setUrl("<c:url value='/adminMem/banList'/>");
			comsubmit.submit();
        }

        function fn_banSearch(pageNo) {
           	var keyword = $('#keyword').val();
			var comAjax = new ComAjax();
			comAjax.setUrl("<c:url value='/adminMem/banSearchList'/>");
       ...
       function fn_memStack(obj){
			...
			comSubmit.setUrl("<c:url value='/adminMem/banReturn' />"); 
        ...
        function fn_showListCallback(data){
			...
			if(total == 0){
				...
				var str = "";
				$.each(data.ban, function(key, value){
					str += "<tr>"
							+ "<td>"+value.MEM_NUM+"</td>"
							+ "<td>"+value.MEM_ID+"</td>"
