...
<form id="reviewForm">
<h2 style="text-decoration: underline; margin-top : 50px">My Review</h2>
    ...
    <%@ include file="/WEB-INF/include/include-body.jspf" %>
        ...
        function fn_ShowDetail(obj){
         ...
         function fn_showList(pageNo){
			...
			comAjax.setUrl("<c:url value='/mypage/selectReviewList'/>");
			comAjax.setCallback("fn_showListCallback");
			comAjax.addParam("REVIEW_ID", "${session_MEM_INFO.MEM_ID}");
 			...
 			if (total == 0) {
				...
				$.each(data.review, function(key, value){
					str += "<tr>"
							...
							+ value.REVIEW_SHOWNAME
							+ "</a>"
							+ "<input type='hidden' id='SHOW_NUM' value=" 
							+ value.REVIEW_SHOWNUM + ">"
							+ "</td>"
							+ "<td>" + value.REVIEW_SCORE + "</td>"
							+ "<td>" + value.REVIEW_CONTENTS + "</td></tr>"
